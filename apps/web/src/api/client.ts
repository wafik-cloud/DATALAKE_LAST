...
export const adminApi = {
  ...
  pelagicSchedules: () => api.get('/api/admin/pelagic/schedules'),
  pelagicCreateSchedule: (data: unknown) => api.post('/api/admin/pelagic/schedules', data),
  pelagicUpdateNamedSchedule: (id: string, data: unknown) => api.put(`/api/admin/pelagic/schedules/${id}`, data),
  pelagicDuplicateSchedule: (id: string) => api.post(`/api/admin/pelagic/schedules/${id}/duplicate`),
  pelagicRunSchedule: (id: string) => api.post(`/api/admin/pelagic/schedules/${id}/run`),
  pelagicDeleteSchedule: (id: string) => api.delete(`/api/admin/pelagic/schedules/${id}`),
